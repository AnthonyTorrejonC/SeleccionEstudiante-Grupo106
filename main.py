...
def añadeRegistos():
    ...
    # crear estudiantes
    estudiante1 = Estudiante(apellidoPaterno="Yurivilca", apellidoMaterno="Canayo", nombres="Luis Alexander",
                             elegible=True)
    estudiante2 = Estudiante(apellidoPaterno="Brayam", apellidoMaterno="Quispe", nombres="Edson",
                             elegible=True)
    estudiante3 = Estudiante(apellidoPaterno="Pizarro", apellidoMaterno="Mallma", nombres="Edilson Marlon",
                             elegible=True)
    estudiante4 = Estudiante(apellidoPaterno="Torrejon", apellidoMaterno="Cañari", nombres="Anthony Cesar",
                             elegible=True)
    ...
    # crear asignatura
    asignatura1 = Asignatura(nombreAsignatura="Construccion de software")
    asignatura2 = Asignatura(nombreAsignatura="Test de software")
